...
const ALL_COLUMNS = [
    ...
    { id: 'subCategory', label: 'Categoria' }, // New Categoria column
    { id: 'provider', label: 'Provedor', restricted: true }, // Only for Fidu
    { id: 'priceAdulto', label: 'Venda (ADU)' },
    { id: 'priceMenor', label: 'Venda (CHD)' },
    { id: 'priceBebe', label: 'Venda (INF)' },
    { id: 'pickup', label: 'Pickup' },
    { id: 'retorno', label: 'Retorno' },
    { id: 'diasElegiveis', label: 'Dias Elegíveis' },
    { id: 'taxasExtras', label: 'Valor Extra' },
